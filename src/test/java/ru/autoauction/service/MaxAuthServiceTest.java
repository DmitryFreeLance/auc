...
class MaxAuthServiceTest {
  @Test void demoAuthenticationIsDisabledInProduction(){
    var props=new AppProperties("token","bot","https://example.ru",Set.of(),Set.of(),false,Duration.ofHours(1),"tmp","password");
  ...
  @Test void acceptsCorrectlySignedMaxData() throws Exception {
    ...
    var props=new AppProperties(token,"bot","https://example.ru",Set.of(),Set.of(42L),false,Duration.ofHours(1),"tmp","password");
