...
public class AuthController {
  ...
  private final MaxAuthService auth; private final CurrentUser current; private final UserRepository users;private final AppProperties props;
  public AuthController(MaxAuthService auth,CurrentUser current,UserRepository users,AppProperties props){this.auth=auth;this.current=current;this.users=users;this.props=props;}
