...
public class AuctionService {
  ...
  @Transactional public BidResult placeBid(long lotId,AppUser user){
    ...
    long amount=Math.addExact(lot.currentPrice,lot.bidStep); Bid bid=bids.save(new Bid(lot,user,amount)); lot.currentPrice=amount; lots.save(lot); return new BidResult(bid,top==null?null:top.user,lot);
  }
